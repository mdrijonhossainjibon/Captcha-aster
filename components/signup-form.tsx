...
export function SignupForm() {
  ...
  const handleSubmitCredentials = async (e: React.FormEvent) => {
    ...
    setIsLoading(true)
    console.log('[v0] Creating account with email:', email)
    
    // Simulate API call to create account and check 2FA status
    await new Promise((resolve) => setTimeout(resolve, 1500))
    
    // Check if 2FA should be enabled for new accounts (simulated)
    const has2FA = true // New signups always have 2FA enabled
    console.log('[v0] New account 2FA status:', has2FA)
