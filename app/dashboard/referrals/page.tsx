...
export default function ReferralsPage() {
    ...
    return (
        <div className="p-4 md:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto animate-in fade-in duration-700">
            {/* Header */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/20 rounded-xl">
                    ...
                    <span className="text-sm font-bold text-primary">Program Active</span>
                </div>
            </div>
